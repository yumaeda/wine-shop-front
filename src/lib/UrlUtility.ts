...
const UTF8_TO_ASCII_MAPPINGS = [
    {
        ascii: 'A',
        regex: /[\u0041\u24B6\uFF21\u00C0\u00C1\u00C2\u1EA6\u1EA4\u1EAA\u1EA8\u00C3\u0100\u0102\u1EB0]/g
    },
    {
        ascii: 'A',
        regex: /[\u1EAE\u1EB4\u1EB2\u0226\u01E0\u00C4\u01DE\u1EA2\u00C5\u01FA\u01CD\u0200\u0202\u1EA0]/g
    },
    ...
    {
        ascii: 'C',
        regex: /[\u0043\u24B8\uFF23\u0106\u0108\u010A\u010C\u00C7\u1E08\u0187\u023B\uA73E]/g
    },
    {
        ascii: 'D',
        regex: /[\u0044\u24B9\uFF24\u1E0A\u010E\u1E0C\u1E10\u1E12\u1E0E\u0110\u018B\u018A\u0189\uA779]/g
    },
    { ascii: 'DZ', regex: /[\u01F1\u01C4]/g },
    { ascii: 'Dz', regex: /[\u01F2\u01C5]/g },
    {
        ascii: 'E',
        regex: /[\u0045\u24BA\uFF25\u00C8\u00C9\u00CA\u1EC0\u1EBE\u1EC4\u1EC2\u1EBC\u0112\u1E14\u1E16]/g
    },
    {
        ascii: 'E',
        regex: /[\u0114\u0116\u00CB\u1EBA\u011A\u0204\u0206\u1EB8\u1EC6\u0228\u1E1C\u0118\u1E18\u1E1A]/g
    },
    { ascii: 'E', regex: /[\u0190\u018E]/g },
    { ascii: 'F', regex: /[\u0046\u24BB\uFF26\u1E1E\u0191\uA77B]/g },
    {
        ascii: 'G',
        regex: /[\u0047\u24BC\uFF27\u01F4\u011C\u1E20\u011E\u0120\u01E6\u0122\u01E4\u0193\uA7A0\uA77D]/g
    },
    { ascii: 'G', regex: /[\uA77E]/g },
    {
        ascii: 'H',
    ...
    {
        ascii: 'I',
        regex: /[\u0049\u24BE\uFF29\u00CC\u00CD\u00CE\u0128\u012A\u012C\u0130\u00CF\u1E2E\u1EC8\u01CF]/g
    },
    { ascii: 'I', regex: /[\u0208\u020A\u1ECA\u012E\u1E2C\u0197]/g },
    { ascii: 'J', regex: /[\u004A\u24BF\uFF2A\u0134\u0248]/g },
    {
        ascii: 'K',
        regex: /[\u004B\u24C0\uFF2B\u1E30\u01E8\u1E32\u0136\u1E34\u0198\u2C69\uA740\uA742\uA744\uA7A2]/g
    },
    {
        ascii: 'L',
        regex: /[\u004C\u24C1\uFF2C\u013F\u0139\u013D\u1E36\u1E38\u013B\u1E3C\u1E3A\u0141\u023D\u2C62]/g
    },
    ...
    {
        ascii: 'O',
        regex: /[\u004F\u24C4\uFF2F\u00D2\u00D3\u00D4\u1ED2\u1ED0\u1ED6\u1ED4\u00D5\u1E4C\u022C\u1E4E]/g
    },
    {
        ascii: 'O',
        regex: /[\u014C\u1E50\u1E52\u014E\u022E\u0230\u00D6\u022A\u1ECE\u0150\u01D1\u020C\u020E\u01A0]/g
    },
    {
        ascii: 'O',
        regex: /[\u1EDC\u1EDA\u1EE0\u1EDE\u1EE2\u1ECC\u1ED8\u01EA\u01EC\u00D8\u01FE\u0186\u019F\uA74A]/g
    },
    { ascii: 'O', regex: /[\uA74C]/g },
    { ascii: 'OI', regex: /[\u01A2]/g },
    { ascii: 'OO', regex: /[\uA74E]/g },
    ...
    {
        ascii: 'R',
        regex: /[\u0052\u24C7\uFF32\u0154\u1E58\u0158\u0210\u0212\u1E5A\u1E5C\u0156\u1E5E\u024C\u2C64]/g
    },
    { ascii: 'R', regex: /[\uA75A\uA7A6\uA782]/g },
    {
        ascii: 'S',
        regex: /[\u0053\u24C8\uFF33\u1E9E\u015A\u1E64\u015C\u1E60\u0160\u1E66\u1E62\u1E68\u0218\u015E]/g
    },
    { ascii: 'S', regex: /[\u2C7E\uA7A8\uA784]/g },
    {
        ascii: 'T',
        regex: /[\u0054\u24C9\uFF34\u1E6A\u0164\u1E6C\u021A\u0162\u1E70\u1E6E\u0166\u01AC\u01AE\u023E]/g
    },
    { ascii: 'T', regex: /[\uA786]/g },
    { ascii: 'TZ', regex: /[\uA728]/g },
    {
        ascii: 'U',
        regex: /[\u0055\u24CA\uFF35\u00D9\u00DA\u00DB\u0168\u1E78\u016A\u1E7A\u016C\u00DC\u01DB\u01D7]/g
    },
    {
        ascii: 'U',
        regex: /[\u01D5\u01D9\u1EE6\u016E\u0170\u01D3\u0214\u0216\u01AF\u1EEA\u1EE8\u1EEE\u1EEC\u1EF0]/g
    },
    ...
    {
        ascii: 'Y',
        regex: /[\u0059\u24CE\uFF39\u1EF2\u00DD\u0176\u1EF8\u0232\u1E8E\u0178\u1EF6\u1EF4\u01B3\u024E]/g
    },
    { ascii: 'Y', regex: /[\u1EFE]/g },
    {
        ascii: 'Z',
        regex: /[\u005A\u24CF\uFF3A\u0179\u1E90\u017B\u017D\u1E92\u1E94\u01B5\u0224\u2C7F\u2C6B\uA762]/g
    },
    {
        ascii: 'a',
        regex: /[\u0061\u24D0\uFF41\u1E9A\u00E0\u00E1\u00E2\u1EA7\u1EA5\u1EAB\u1EA9\u00E3\u0101\u0103]/g
    },
    {
        ascii: 'a',
        regex: /[\u1EB1\u1EAF\u1EB5\u1EB3\u0227\u01E1\u00E4\u01DF\u1EA3\u00E5\u01FB\u01CE\u0201\u0203]/g
    },
    ...
    {
        ascii: 'c',
        regex: /[\u0063\u24D2\uFF43\u0107\u0109\u010B\u010D\u00E7\u1E09\u0188\u023C\uA73F\u2184]/g
    },
    {
        ascii: 'd',
        regex: /[\u0064\u24D3\uFF44\u1E0B\u010F\u1E0D\u1E11\u1E13\u1E0F\u0111\u018C\u0256\u0257\uA77A]/g
    },
    { ascii: 'dz', regex: /[\u01F3\u01C6]/g },
    {
        ascii: 'e',
    ...
    {
        ascii: 'h',
        regex: /[\u0068\u24D7\uFF48\u0125\u1E23\u1E27\u021F\u1E25\u1E29\u1E2B\u1E96\u0127\u2C68\u2C76]/g
    },
    { ascii: 'h', regex: /[\u0265]/g },
    { ascii: 'hv', regex: /[\u0195]/g },
    {
        ascii: 'i',
        regex: /[\u0069\u24D8\uFF49\u00EC\u00ED\u00EE\u0129\u012B\u012D\u00EF\u1E2F\u1EC9\u01D0\u0209]/g
    },
    ...
    {
        ascii: 'o',
        regex: /[\u014D\u1E51\u1E53\u014F\u022F\u0231\u022B\u1ECF\u0151\u01D2\u020D\u020F\u01A1\u1EDD]/g
    },
    {
        ascii: 'o',
        regex: /[\u1EDB\u1EE1\u1EDF\u1EE3\u1ECD\u1ED9\u01EB\u01ED\u00F8\u01FF\u0254\uA74B\uA74D\u0275]/g
    },
    { ascii: 'oe', regex: /[\u00F6]/g },
    { ascii: 'oi', regex: /[\u01A3]/g },
    { ascii: 'ou', regex: /[\u0223]/g },
    ...
    {
        ascii: 't',
        regex: /[\u0074\u24E3\uFF54\u1E6B\u1E97\u0165\u1E6D\u021B\u0163\u1E71\u1E6F\u0167\u01AD\u0288]/g
    },
    { ascii: 't', regex: /[\u2C66\uA787]/g },
    { ascii: 'tz', regex: /[\uA729]/g },
    {
        ascii: 'u',
        regex: /[\u0075\u24E4\uFF55\u00F9\u00FA\u00FB\u0169\u1E79\u016B\u1E7B\u016D\u01DC\u01D8\u01D6]/g
    },
    {
        ascii: 'u',
        regex: /[\u01DA\u1EE7\u016F\u0171\u01D4\u0215\u0217\u01B0\u1EEB\u1EE9\u1EEF\u1EED\u1EF1\u1EE5]/g
    },
